...
Total providers: **297**. See category breakdown below.
...
| `xai` | `xai` | xAI (Grok) | API key | [link](https://x.ai) | Use an official xAI API key from x.ai. Grok Build JWT sessions remain a separate provider. |
