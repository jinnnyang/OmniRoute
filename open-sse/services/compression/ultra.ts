 ...
 * NEVER mangles structured content (mirrors caveman.ts).
 *
...
/** The ultra tier recorded on the stats (always "heuristic" — SLM tier removed). */
export type UltraTier = "heuristic";

/**
 * Ultra — pure, synchronous heuristic token pruning.
 * Used directly by the stacked sync engine (`cavemanAdapter`).
 */
